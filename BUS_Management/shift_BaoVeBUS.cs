...
namespace BUS_Management
{
    public class shift_BaoVeBUS
    {
        ...
        {
            return this.shift_baoveDAL.getIdName_ByCaThuID(Ca, Thu, idNV);
        }
        public DataTable getShift()
        {
            return this.shift_baoveDAL.getShift();
        }
        ...
        {
            return this.shift_baoveDAL.ResetShift_BaoVe();
        }

        public DataTable getALLShift_BaoVe()
        {
            return this.shift_baoveDAL.getALLShift_BaoVe();
        }

        public void chiaCaBaoVe()
        {
        ...
        private shift_BaoVeDTO dto(string id_nv, int thu, int ca)
        {
            shift_BaoVeDTO shift_BaoVeDTO;
            if (thu == 2)
            {
                shift_BaoVeDTO = new shift_BaoVeDTO(id_nv, ca, 0, 0, 0, 0, 0, 0);
            }    
            else if (thu == 3)
            {
                shift_BaoVeDTO = new shift_BaoVeDTO(id_nv, 0, ca, 0, 0, 0, 0, 0);
            }    
            else if (thu == 4)
            {
                shift_BaoVeDTO = new shift_BaoVeDTO(id_nv, 0, 0, ca, 0, 0, 0, 0);
            }    
            else if (thu == 5)
            {
                shift_BaoVeDTO = new shift_BaoVeDTO(id_nv, 0, 0, 0, ca, 0, 0, 0);
            }    
            else if (thu == 6)
            {
                shift_BaoVeDTO = new shift_BaoVeDTO(id_nv, 0, 0, 0, 0, ca, 0, 0);
            }    
            else if (thu == 7)
            {
                shift_BaoVeDTO = new shift_BaoVeDTO(id_nv, 0, 0, 0, 0, 0, ca, 0);
            }    
            else
            {
                shift_BaoVeDTO = new shift_BaoVeDTO(id_nv, 0, 0, 0, 0, 0, 0, ca);
            }
            return shift_BaoVeDTO;
        }
