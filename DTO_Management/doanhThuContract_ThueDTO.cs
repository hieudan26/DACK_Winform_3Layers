...
{
    public class doanhThuContract_ThueDTO
    {
        private string sid;
        private float fTotalCost;
        private string sidEmployee;

        public doanhThuContract_ThueDTO(string sid, float fTotalCost, string sidEmployee)
        {
            this.sid = sid;
        ...
        public doanhThuContract_ThueDTO() { }

        ~doanhThuContract_ThueDTO() { }
    }
}
