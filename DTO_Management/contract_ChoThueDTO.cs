...
{
    public class contract_ChoThueDTO
    {
        private string sid;
        ...
        public contract_ChoThueDTO(string sid, string sidCustomer, string sidVehicle, DateTime dtdateSign, float fTotalCost, string idEmployee)
        {
            this.sid = sid;
