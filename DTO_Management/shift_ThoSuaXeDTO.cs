...
{
    public class shift_ThoSuaXeDTO
    {
        ...
        public shift_ThoSuaXeDTO()
        {

        }

        public shift_ThoSuaXeDTO(string id_NV, int thu2, int thu3, int thu4, int thu5, int thu6, int thu7, int chunhat)
        {
            this.sid_NV = id_NV;
            this.iThu2 = thu2;
            this.iThu3 = thu3;
